...
<div class="row-wrap">
<h3>Assign A License</h3>
<hr>
</div>

<div class="container">
					<p>
					<form:errors class="alert alert-danger" path="newLicenseObject.*"></form:errors>
				</p>
			<form:form action="/licenses/new" method="post"
				modelAttribute="newLicenseObject">
				<p>
					<form:select path="person" class="form-control col-6">
				...
				<p>
					...
					<form:input path="expiration_date" type="date" class="form-control col-6" />
				</p>
